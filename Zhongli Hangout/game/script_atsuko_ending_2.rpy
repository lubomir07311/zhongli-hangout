label atsuko_ending_2:
    p "That's right! The refugee we once helped find a job in Liyue. She was the lucky one to escape Inazuma since the tight measures were enforced by the Inazuma authorities."
    ...
    z "This is the first I'm hearing of this Atsuko person."
    t "She is a brave girl, who built her own raft to escape from Inazuma. She was planning on becoming a sailor, but last time we left her with some paperwork for Clerk Zhao."
    ...
    z "As ridiculous as it sounds, we can't rule out the possibility. She might not be a Vision bearer, but as someone who comes from Inazuma, she might be helping the Inazuma Vision bearer wreak havoc on the streets on Liyue."
    ...
    p "But that's an Inazuma Geo Vision. We know that the Electro Archon, that rules over Inazuma in trying to gather all the Visions for herself, not give them away."
    z "That's correct."
    ...
    p "Atsuko, when you got the Vision, was it empty? Like a blank pale stone in the middle? Or was it always orange with the Geo symbol?"
    ...
    p "Mhm~ And once your training is complete, maybe you can sign up for the Adventurers' Guild."
    ...
    z "Very well then. Miss Atsuko, could you show us what you can do so far?"
    ...
    p "She is doing pretty well for someone, who was afraid of her Vision just a few hours ago."
...
label demoralized:
    ...
    z "I don't know her that well, but perhaps the initial shock from the accident from earlier has passed and she is calmer now."
...
label inspired:
    ...
    z "Miss Atsuko, I'd be honored. As long as you are in Liyue, you can swing by the Wangsheng Funeral Parlor for lessons anytime."

label atsuko_ending_2:
    ...
    z "It's the first time I'm hearing of this Atsuko person."
    ...
    z "As ridiculous as it sounds, we can't rule out the possibility. She might not be a vision bearer, someone that comes from Inazuma, she might be helping someone else wreak havoc on the streets on Liyue."

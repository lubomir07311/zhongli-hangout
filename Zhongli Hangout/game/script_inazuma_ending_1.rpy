label inazuma_ending_1:
    ...
    z "While we can't go to any of the populated areas in Inazuma, we might be able to sneak into one of their islands. Once there, I can call an old favor and we can meet with an insider."
    ...
    z "Please remember! And this is very important. Even though it is just a suspicion for now, do not discuss the presence of an Inazuma Geo Vision bearer on Liyue's territory with {i}anyone{/i}! You got that?"
    p "Loud and clear!"
    ...
    t "It is a bit risky to rely on him this much though. I'm thankful he is on our side."
    ...
    t "We did! I'm impressed that you were able to arrange transport on such a short notice."
    ...
    p "But it's different. This is an Inazuma aquatic slime. Yuck!"
    t "You'll be fine. Just a few handfuls in the bag and we are done. What is your friend using it for anyway, Zhongli?"
    ...
    "{i}*Bushes rustling*{/i}"
    p "Did you hear that? You just mention her name on these lands and the bushes start to tremble."
    t "I'm sure that was just a coincidence, Paimon. Look, there's nothing over there."
    "{i}*Rustling intensifies*{/i}"
    ...
    t "My reputation precedes me I see. Although, I haven't done much around here. I'm just on my journey."
    ...
    a "Recovering from the initial shock, they could not believe their eyes. Each one of them was safe and sound. However, the same could not have been said for the Vision bearer."
    ...
    t "You couldn't have picked a worse spot to tell that story. With all the bones surrounding us..."
    ...
    "{i}*inaudible dialogue in the distance*{/i}"
    t "What was that?"
    a "Oh no! The Kanjobugyo are here."
    p "The Kanjo-what-now?"
    a "The Kanjobugyo. The authority which monitors Inazuma's borders and one of the three organizations that comprise the Tri-Commission. They work with the Inazuma Bakufu, and are led by the Electro Archon, Baal."
    ...
    z "That's because it is an Inazuma cruiser. It's not your ordinary fleet ship like the Mizar here. It's built for fast military navigation."
    ...
    p "Um, excuse me, good sir. Would you mind telling us what is going on here? What is an Inazuma military ship doing docked at Liyue Harbor?"
    ...
    z "Let it go! This is a battle we cannot win."

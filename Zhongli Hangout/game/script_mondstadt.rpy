...
label mondstadt_square:
    ...
    n "I hope I have not given the the wrong impression about the maids from Mondstadt."
    ...
    t "Nonsense, Timaeus. I think highly of your achemical research and experience. It's just that sometimes I'm in a hurry and can't stay to chat, although I would love to. But I have some time just now. Where are you off to?"
    ...
    t "Oh.. trying to make a conversation, but I can see that you are busy packing, so I'll let you be. Wish all the best to Albedo and Sucrose from me when you see them again. We will catch up once your expedition is over!"
    ...
    t "I do. I took a peak at Timaeus' bags while he was packing, and they were full of alchemy supplies. I think I caught a glimps of some containers of paint and some food boxes as well."
    ...
    p "But staying here would be safer and it means you can have a taste of the dandelion wine you mentioned before."
    z "You make an excellent point, Paimon. The sooner we solve the case, the better, but is it worth risking getting caught in the storm or should we wait for it to pass?"
...
label choices_mondstadt_night:
    ...
    menu:
        ...
        "Stay in Mondstadt":
            ...
            p "Zhongli, you said that you are after some dandelion wine, right?"
            ...
            p "Well there's always the Angel's Share. The classic Mondstadt tavern with the locally sourced dandelion wine from the Dawn Winery. It is just what you came here for."
            z "Although I came for the dandelion wine, I wouldn't mind experiencing the new buzz in town with your friend's cocktails."
...
label choices_mondstadt_drinks:
    menu:
        ...
        "Angel's Share":
            ...
            t "Or can't remember - it all depends on the amount of dandelion wine."
            z "Haha~ it would take a lot of dandelion wine for someone like me to not remember the night before."

...
label ningguang_office:
    ...
    z "Greetings, good man. We are here to meet with Lady Ningguang."
    b "I'm afraid that she is occupied by administrative tedium, and cannot meet you presently."
    p "It is super-duper important, Mr. Bu'yun. You know us. We wouldn't bother Lady Ningguang if we didn't have a solid reason."
    ...
    z "We would have, but this issue is concerning Lady Ningguang personally. So would you please arrange a meeting immediately?"
...
label mondstadt_trip_talk:
    ...
    z "The Geo Archon is {i}\"gone\"{/i} as you know very well. I don't see any new Geo Visions being gifted anytime soon."
    ...
    t "I wasn't considering Lady Ningguang either, but you insisted on visiting her. So now this is my hunch."
    z "Could somebody please fill me in. I think I'm lost."
    t "See, there's this girl in Mondstadt. She is the sweetest maid and would never hurt anybody."
    ...
    t "Stories aside, I was helping her prepare for her knightly exam, and we decided to take a trip to Liyue. I took her to the Wanmin restaurant and she tasted the authentic cuisine, which as we all know is fairly spicy."
    ...
    t "Typically, no. She is well-known in Mondstadt to be a protector of the weak. Everybody has good relations with her. But last time we saw her, I was worried she might have overworked herself."
    ...
    z "An opportunity to taste an authentic dandelions wine once more? How can I decline such an invitation? While at it, I might catch up with an old friend I haven't seen in a while."
